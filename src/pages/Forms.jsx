                ...
                <div className='left_of_forms'>
                    <div className='top_three_forms_list'>
                        ...
                        <div className="button-container-3" >
                            <span className="mas3">Active</span>
                                <button className='buttonFront3' id='work2' type="button" name="Hover">
                                    <h3 className='inner_text_button_forms_page'>Active</h3>
                                </button>
                        </div>
                        <div className="button-container-3" >
                            <span className="mas3">Offboard</span>
                                <button className='buttonFront3' id='work2' type="button" name="Hover">
                                    <h3 className='inner_text_button_forms_page'>Offboard</h3>
                                </button>
                        </div>
                    </div>
